...
\firstSupervisor{Köhler-Büßmeier}
\secondSupervisor{}    % only if needed, otherwise left blank

% text field
%-> replace title with your title of the seminar work
\termPaperTitle{Minimale Distanz in RG}
\termPaperTitleEN{minimal distance in RG}


% text field
%-> replace the key words with your own key words or remove the words
\keywordsDE{Minimale Distanz in RG}
\keywordsEN{minimal distance in RG}

% text field
%-> replace john with your name
\termPaperAuthor{Gruppe 5 - Usman Amini, Jessica Lim, Arne-Thorben Weber}

% text field
%-> enter the submission date
\submissionDate{26.19.2024}
